...
//   // ✅ Correct: useEffect to update data
//   useEffect(() => {
//     if (invoiceData) {
//       setFormData({
//         title: "Invoice Receipt",
...
//               <p className="text-sm text-gray-500">{formData.businessEmail}</p>
//               <p className="text-sm text-gray-500">{formData.businessPhone}</p>
...
//               <p><strong>Email:</strong> {formData.customerEmail || "N/A"}</p>
...
//               <p><strong>Time:</strong> {toDisplayAMPM(formData.bookingTime)}</p>
//               <p><strong>Staff:</strong> {formData.staff || "-"}</p>
//               <p><strong>Payment:</strong> {formData.paymentMethod || "cash"}</p>
//             </div>
//           </div>
...
//                     <td className="p-3 text-right">AED {Number(s.price).toFixed(2)}</td>
...
//               <span>Subtotal:</span>
//               <span>AED {Number(formData.totalPrice || 0).toFixed(2)}</span>
//             </div>
//             <div className="flex justify-between w-64">
//               <span>Tip:</span>
//               <span className="text-green-600">AED {Number(formData.tip || 0).toFixed(2)}</span>
//             </div>
//             <div className="flex justify-between w-64">
//               <span>Discount:</span>
